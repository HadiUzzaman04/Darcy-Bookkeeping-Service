    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <P>We took over the bookkeeping and BAS duties for this client who has multiple business entities. We changed the current BAS process that the business was used to into something much simpler that would ensure accuracy timely processing. The document arrives via email, the client reviews, signs online, gets payment details, makes payment and completes the process.</P>
            </div>
        </div>
    </div>
</div>
