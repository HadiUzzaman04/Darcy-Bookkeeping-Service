...
<div class="page-heading about-heading header-text" style="background-image: url('website/images/heading-5-1920x500.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Our bookkeeping team has a proven track record of getting books up to date quickly and at an affordable cost. As Registered BAS Agents, we also can help alleviate your stress by communicating directly with the Tax Office and letting them know that we have your books in hand and indicating a firm timeline for completion of BAS or Tax Returns. We can also help you to negotiate with the tax office with regards to any outstanding debts you may have also.</p>
            </div>
        </div>
    </div>
</div>
...
<table class="table table-bordered table-dark">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Final review to ensure all data entered is correct and nothing has been missed. Any final adjustments are made with books now ready for BAS, Tax or any other outstanding lodgements.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>As BAS Agents we have a priority phone line to the ATO</td>
